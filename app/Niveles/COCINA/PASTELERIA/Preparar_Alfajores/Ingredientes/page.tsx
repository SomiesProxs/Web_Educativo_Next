...
export default function Page() {
      ...
      try {
        const response = await fetch('/api/obtenerContenidoSubtema', {
          ...
          body: JSON.stringify({
            nivel: 'COCINA',
            curso: 'PASTELERIA',
            titulo: 'Preparar Alfajores', // Usar título original para buscar en BD
            subtema: '¿Ingredientes?' // Usar subtema original para buscar en BD
          }),
        });
  ...
  return (
    <div className="subtema-container bg-gray-100 p-6 rounded-lg shadow-lg max-w-4xl mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4 text-gray-800">Preparar Alfajores</h1>
      <h2 className="text-xl font-semibold mb-6 text-gray-700">¿Ingredientes?</h2>
      <div
