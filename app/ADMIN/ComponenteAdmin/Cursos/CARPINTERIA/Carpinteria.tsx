...
interface CARPINTERIACarpinteriaProps {
  onVolver: () => void;
}

export default function CARPINTERIACarpinteria({ onVolver }: CARPINTERIACarpinteriaProps) {
  ...
  return (
    <div className="p-8 rounded-lg max-w-3xl mx-auto">
      ...
      <h2 className="text-3xl font-bold mb-6">TEMAS Y SUBTEMAS DE CARPINTERIA</h2>
