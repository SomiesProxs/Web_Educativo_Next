...
interface MISAELMisaelProps {
  onVolver: () => void;
}

export default function MISAELMisael({ onVolver }: MISAELMisaelProps) {
  ...
  return (
    <div className="p-8 rounded-lg max-w-3xl mx-auto">
      ...
      <h2 className="text-3xl font-bold mb-6">TEMAS Y SUBTEMAS DE MISAEL</h2>
